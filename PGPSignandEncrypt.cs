...
{
    public static class PGPSignandEncrypt
    {
        [FunctionName("PGPSignandEncrypt")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Function,  "post", Route = null)] HttpRequest req,
            ILogger log)
        {
           log.LogInformation($"C# HTTP trigger function {nameof(PGPSignandEncrypt)} received a request.");   
            ...
            encryptedData = await PGPHelper.EncryptAndSignAsync(req.Body,publicKey, privateKey,passPhrase); 
